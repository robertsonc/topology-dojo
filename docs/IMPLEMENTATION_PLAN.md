...
| O7  | Decide 0004's open decisions: staging hostname (via O3), approvers, observation window / error-rate stop threshold, manual-only staging dispatch or a `staging` branch                                                                                                                                            | Humans               | D5 finalization                                   |
