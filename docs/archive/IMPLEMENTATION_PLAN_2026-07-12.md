> [!IMPORTANT]
> **HISTORICAL DOCUMENT — FULLY EXECUTED, DO NOT TREAT AS CURRENT.**
> This plan's "Current state (verified 2026-07-12)" section below was
> accurate on 2026-07-12. As of 2026-07-19, **every packet in this document
> has shipped** — Proposal 0004 (isolated staging + deployment pipeline) is
> fully live, production-activated, and has run through migrations `v1`–`v5`;
> Proposal 0003 (adaptive authoring profiles, packets P1–P5) is live in
> production; every packet in the D/B/R/S/I series (D1–D6, B1, R0–R4, S1–S4
> except the deliberately-skipped S4, I1–I2) is merged. **None of the
> "Current state" claims below (e.g. "Proposal 0004 is unimplemented",
> "Proposal 0003 is unimplemented", "no `WORKSPACE_ENABLED` flag in code")
> are true anymore.** This file is preserved only for historical record of
> how that work was planned and sequenced.
>
> For current status, see [`../ROADMAP.md`](../ROADMAP.md) (production
> baseline + active initiatives) and [`../CAPABILITY_MATRIX.md`](../CAPABILITY_MATRIX.md)
> (capability-by-capability evidence). For the active plan, see
> [`../IMPLEMENTATION_PLAN.md`](../IMPLEMENTATION_PLAN.md).

# Implementation Plan — July 12 proposals + roadmap _(historical, fully executed)_

**Status:** Accepted plan of record — **superseded, all packets shipped; see banner above**
**Captured:** 2026-07-12
